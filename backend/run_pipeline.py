...
try:
    ...
    high_sev = db.query(ExceptionModel).filter(ExceptionModel.severity == 'high').count()
    medium_sev = db.query(ExceptionModel).filter(ExceptionModel.severity == 'medium').count()
    open_count = db.query(ExceptionModel).filter(ExceptionModel.status == 'open').count()
